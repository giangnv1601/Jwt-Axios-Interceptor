...
const login = async (req, res) => {
  try {
     ...
     * Đối với cái maxAge - thời gian sống của Cookie thì chúng ta sẽ để tối đa sống 14 ngày, tùy dự án. Lưu ý thời gian sống của cookie khác với cái thời gian sống của token nhé. Đừng bị nhầm lẫn
     */
...
const refreshToken = async (req, res) => {
  try {
    ...
    // Trả lại accessToken mới cho trường hợp FE cần update lại trong localstorage
